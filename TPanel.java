...
public class TPanel extends JPanel {
    ...
    public boolean setBackgroundImage(String imagePath) {
        ...
        try {
            ...
            System.out.println("Image loaded successfully. Dimensions: " +
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (backgroundImage != null && getWidth() > 0 && getHeight() > 0) {
            if (stretchToFill) {
                ...
                System.out.println("Drawing stretched image at: 0,0 with size: " +
                ...
                System.out.println("Drawing proportional image at: " + x + "," + y +
