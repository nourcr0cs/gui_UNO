...
public class Human extends Player {
	...
	// Constructor
	/*
	 * Human(Player prev, Player next, String name) { super(prev, next, name);
	...
	public Card makeMove(Card topCard, String colorToPlay) {
		while (true) {
			...
			System.out.println("Enter the number of the card you want to play (1-" + getHandSize()
					+ ") or 'draw' to draw a card:");
