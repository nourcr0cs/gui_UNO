...
public class Bot extends Player {
	private final static String[] botNames = { "Kevin", "Whispy", "Aurora", };
	...
	/*
	 * @Override public String chooseColor() { int blue = 0, green = 0, red = 0,
	 * yellow = 0; for (Card card : getHand()) { String color = card.getColor();
	 * switch (color) { case "Blue" -> blue++; case "Green" -> green++; case "Red"
	 * -> red++; case "Yellow" -> yellow++; } } int max = Math.max(Math.max(blue,
	 * green), Math.max(red, yellow)); if (max == blue) return "Blue"; if (max ==
	 * green) return "Green"; if (max == red) return "Red"; return "Yellow"; } }
	 */
