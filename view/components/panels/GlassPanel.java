...
/**
 * A custom panel that simulates a modern glass/blur effect
 * with rounded corners and subtle highlights
 */
public class GlassPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        RoundRectangle2D glassShape = new RoundRectangle2D.Float(
