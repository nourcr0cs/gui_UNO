...
public class PlayerLabel extends JLabel {
	 ...
	 * 
	 * double rotationAngle = 0; switch (getPlayerPosition()) { case 0:
	 * rotationAngle = 0; break; case 1: rotationAngle = Math.toRadians(270); break;
	 * case 2: rotationAngle = Math.toRadians(180); break; case 3: rotationAngle =
	 * Math.toRadians(90); break; }
	 * 
	 ...
	 * 
	 * FontMetrics fm = g2d.getFontMetrics(getFont()); int textWidth =
	 * fm.stringWidth(getText()); int textHeight = fm.getHeight(); int x =
	 * (getWidth() - textWidth) / 2; int y = (getHeight() + fm.getAscent()) / 2;
	 * 
	 * g2d.setColor(isActive ? ACTIVE_COLOR : DEFAULT_COLOR);
	 * g2d.setFont(getFont()); g2d.drawString(getText(), x, y);
	 * 
	 * g2d.dispose(); }
	 */
