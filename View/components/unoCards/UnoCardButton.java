...
public class UnoCardButton extends JButton {
	...
	protected void paintComponent(Graphics g) {
		...
		g2d.draw(new RoundRectangle2D.Double(BORDER_WIDTH / 2, BORDER_WIDTH / 2, width - BORDER_WIDTH,
				height - BORDER_WIDTH, ARC_WIDTH, ARC_HEIGHT));
	...
	public void setAssociatedCard(Model.Card card) {
		this.card = card;
	}

	// methode pour récupérer la carte associée
	public Model.Card getAssociatedCard() {
		return card;
	}
}