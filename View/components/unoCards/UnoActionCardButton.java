...
public class UnoActionCardButton extends UnoCardButton {
	...
	private void drawSkipSymbol(Graphics2D cmp, int width, int height) {
		...
		cmp.drawLine(centerX - (int) (diagonalLength / 2), centerY - (int) (diagonalLength / 2),
		...
		cmp.drawLine(width / 12 + (int) ((cornerSize - cornerDiagonal) / 2),
		...
		cmp.setClip(new Ellipse2D.Double(width - width / 12 - cornerSize, height - height / 12 - cornerSize, cornerSize,
				cornerSize));
		...
		cmp.drawLine(width - width / 12 - cornerSize + (int) ((cornerSize - cornerDiagonal) / 2),
	...
	private void drawDrawTwoSymbol(Graphics2D cmp, int width, int height) {
		...
		cmp.setColor(cardColor.getColor());
		roundedRect(cmp, centerX - cardWidth / 2 - offset / 2, centerY - cardHeight / 2 + offset / 2, cardWidth,
				cardHeight, 5);
		...
		roundedRectOutline(cmp, centerX - cardWidth / 2 + offset / 2, centerY - cardHeight / 2 - offset / 2, cardWidth,
				cardHeight, 5);
