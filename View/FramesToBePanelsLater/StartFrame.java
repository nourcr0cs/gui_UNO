/*******************  Supposed to be the Start Panel in Main Frame  *********************************/
...
public class StartFrame extends JFrame {
	...
	private static final String[] IMAGE_PATHS = { "/view/images/uno_background.jpg", "/images/uno_background.jpg",
			"/resources/images/uno_background.jpg", "/uno_background.jpg", "uno_background.jpg",
			"./view/images/uno_background.jpg", "../images/uno_background.jpg", "../../images/uno_background.jpg" };
		...
		return new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				...
				if (backgroundImage != null) {
					...
					GradientPaint gradient = new GradientPaint(0, 0, new Color(18, 85, 85), getWidth(), getHeight(),
							new Color(10, 45, 45));
	...
	private void createFallbackBackgroundImage() {
		...
		GradientPaint gradient = new GradientPaint(0, 0, new Color(18, 85, 85), width, height, new Color(10, 45, 45));
		g2d.setPaint(gradient);
